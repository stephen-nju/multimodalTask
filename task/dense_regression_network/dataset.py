...
class CharadesSTA(Dataset):
    def __init__(self, dataset_configs, split='train', transform=None):
        ...
        self.lang_data = list(
            open(f"task/dense_regression_network/data/dataset/Charades/Charades_sta_{split}.txt", 'r'))
        self.fps_info = json.load(
            open('task/dense_regression_network/data/dataset/Charades/Charades_fps_dict.json', 'r'))
        self.duration_info = json.load(
            open('task/dense_regression_network/data/dataset/Charades/Charades_duration.json', 'r'))
        self.word2id = json.load(open('task/dense_regression_network/data/dataset/Charades/Charades_word2id.json', 'r'))
        self.ft_root = dataset_configs['feature_root']
        self.ft_window_size = dataset_configs['ft_window_size']
        self.ft_overlap = dataset_configs['ft_overlap']
